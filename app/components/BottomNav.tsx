...
export const BottomNav: React.FC<BottomNavProps> = ({ selected, onNavigate, onCreatePost }) => {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.navItem} onPress={() => onNavigate('home')} activeOpacity={0.7}>
        {selected === 'home' ? (
          <>
            ...
            <LinearGradient colors={GRADIENTS.primary} start={{ x: 0, y: 0 }} end={{ x: 0.233, y: 1.155 }} style={styles.gradientText}>
      ...
      <TouchableOpacity style={styles.createButton} onPress={onCreatePost} activeOpacity={0.8}>
        <LinearGradient colors={GRADIENTS.primary} start={{ x: 0, y: 0 }} end={{ x: 0.233, y: 1.155 }} style={styles.createButtonGradient}>
      ...
      <TouchableOpacity style={styles.navItem} onPress={() => onNavigate('notifications')} activeOpacity={0.7}>
        <Svg width="36" height="36" viewBox="0 0 36 36" fill="none">
          <Path
            d="M13.5 25.5V27C13.5 28.1935 13.9741 29.3381 14.818 30.182C15.6619 31.0259 16.8065 31.5 18 31.5C19.1935 31.5 20.3381 31.0259 21.182 30.182C22.0259 29.3381 22.5 28.1935 22.5 27V25.5M15 7.5C15 6.70435 15.3161 5.94129 15.8787 5.37868C16.4413 4.81607 17.2044 4.5 18 4.5C18.7956 4.5 19.5587 4.81607 20.1213 5.37868C20.6839 5.94129 21 6.70435 21 7.5C22.7226 8.31454 24.1911 9.58249 25.2481 11.1679C26.305 12.7534 26.9107 14.5966 27 16.5V21C27.1129 21.9326 27.4432 22.8256 27.9642 23.6072C28.4853 24.3888 29.1826 25.0371 30 25.5H6C6.81741 25.0371 7.51471 24.3888 8.03578 23.6072C8.55685 22.8256 8.88712 21.9326 9 21V16.5C9.08934 14.5966 9.69495 12.7534 10.7519 11.1679C11.8089 9.58249 13.2774 8.31454 15 7.5Z"
            stroke={COLORS.textTertiary}
            strokeWidth="3"
            strokeLinecap="round"
            strokeLinejoin="round"
